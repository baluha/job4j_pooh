...
public class TopicServiceTest {
    ...
    public void topic() {
        ...
        String paramForPublisher = "temperature=18";
        String paramForSubscriber1 = "client407";
        String paramForSubscriber2 = "client34";
        ...
        Resp res1 = topicService.process(
                new Req("GET", "topic", "weather", paramForSubscriber1));
        Resp res2 = topicService.process(
                new Req("GET", "topic", "weather", paramForSubscriber2));
        Resp res3 = topicService.process(
                new Req("GET", "topic", "weather", paramForSubscriber2));
        assertThat(res1.text()).isEqualTo("temperature=18");
        assertThat(res2.text()).isEqualTo("temperature=18");
        assertThat(res3.text()).isEqualTo("");
    }
}